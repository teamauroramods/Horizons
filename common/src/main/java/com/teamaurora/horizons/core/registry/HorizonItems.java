...
public class HorizonItems {
    ...
    public static final Supplier<Item> CYPRESS_BOAT_ITEM = ITEMS.register("cypress_boat", () -> new PollinatedBoatItem(HorizonBoatTypes.CYPRESS, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
