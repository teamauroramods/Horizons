...
public class HorizonsBlockTagsProvider extends BlockTagsProvider {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.SMALL_FLOWERS).add(RED_MALLOW.get(), WHITE_MALLOW.get(), MALLOW_BUSH.get(), SUNNY_MARIGOLD.get(), SHADY_MARIGOLD.get(), AMARANTH.get(), FIDDLENECK.get(), FORGET_ME_NOT.get(), BLUE_DAISY.get(), ORANGE_DAISY.get(), PINK_DAISY.get(), PURPLE_DAISY.get(), YELLOW_DAISY.get());
        this.tag(BlockTags.TALL_FLOWERS).add(MARIGOLD_BUSH.get(), HELICONIA.get());
        ...
        this.tag(BlockTags.FLOWER_POTS).add(
                ...
                POTTED_RED_MALLOW.get(), POTTED_WHITE_MALLOW.get(), POTTED_MALLOW_BUSH.get(),
                POTTED_SUNNY_MARIGOLD.get(), POTTED_SHADY_MARIGOLD.get(), POTTED_MARIGOLD_BUSH.get(),
                POTTED_AMARANTH.get(), POTTED_FIDDLENECK.get(), POTTED_HELICONIA.get(), POTTED_FORGET_ME_NOT.get(),
                POTTED_BLUE_DAISY.get(), POTTED_ORANGE_DAISY.get(), POTTED_PINK_DAISY.get(), POTTED_PURPLE_DAISY.get(), POTTED_YELLOW_DAISY.get()
        );
        ...
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(CYPRESS_CABINET.get(), JACARANDA_CABINET.get(), REDWOOD_CABINET.get(), SHORT_TROPICAL_GRASS.get(), TALL_TROPICAL_GRASS.get(), SHORT_SWAMP_GRASS.get(), TALL_SWAMP_GRASS.get());

        this.tag(BlockTags.REPLACEABLE).add(HANGING_CYPRESS_LEAVES.get(), SHORT_TROPICAL_GRASS.get(), TALL_TROPICAL_GRASS.get(), SHORT_SWAMP_GRASS.get(), TALL_SWAMP_GRASS.get());
        this.tag(BlockTags.REPLACEABLE_BY_TREES).add(SHORT_TROPICAL_GRASS.get(), TALL_TROPICAL_GRASS.get(), SHORT_SWAMP_GRASS.get(), TALL_SWAMP_GRASS.get());

        this.tag(BlockTags.SWORD_EFFICIENT).add(SHORT_TROPICAL_GRASS.get(), TALL_TROPICAL_GRASS.get(), SHORT_SWAMP_GRASS.get(), TALL_SWAMP_GRASS.get());
