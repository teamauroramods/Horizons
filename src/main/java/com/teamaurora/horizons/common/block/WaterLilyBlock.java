...
public class WaterLilyBlock extends FlowerBlock implements BonemealableBlock {
    ...
    private static final List<WaterLilyBlock> LILY_FLOWERS = new ArrayList<>();

    public WaterLilyBlock(Properties builder) {
    ...
    public static Block getRandomLily(RandomSource rand) {
        return Util.getRandom(LILY_FLOWERS, rand);
    }
    ...
    public void performBonemeal(ServerLevel serverLevel, RandomSource randomSource, BlockPos blockPos, BlockState blockState) {
        popResource(serverLevel, blockPos, new ItemStack(this.asItem(), 1));
    }
}
